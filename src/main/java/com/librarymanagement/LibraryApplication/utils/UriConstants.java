...
public class UriConstants {
    ...
    public static final String GET_COUNT_BORROWED_BOOKS =
            "api/v1/report/borrowed-books/total/count";
    public static final String GET_COUNT_BORROWED_BOOKS_UNIQUE =
            "api/v1/report/borrowed-books" + "/unique" + "/count";
