...
public class UriConstants {
    ...
    public static final String GET_AVAILABLE_BOOK_COUNT = "/api/v1/report/book-count/available";
    public static final String GET_TOTAL_BOOKS_COUNT = "/api/v1/report/book-count/total";
